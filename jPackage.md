...
```cmd
jpackage --input target/ --name "FloatDataVisualizer_1_2_0" --main-jar FloatDataVisualizer-2.1.2.0.jar --main-class com.alphagen.studio.FloatDataVisualizer.Launcher --type dmg --java-options '--enable-preview' --icon /Users/veerabhadram/IdeaProjects/FloatDataVisualizer/src/main/resources/com/alphagen/studio/FloatDataVisualizer/float_data_recorder_2_png_icon_2.icns --dest installer --app-version 1.2.0 --vendor MiramarWaterJets --verbose --module-path "/Users/veerabhadram/Desktop/Aadarsh/Development/Java/java_libs/javafx-sdk-23.0.1/lib;/Users/veerabhadram/Desktop/Aadarsh/Development/Java/java_libs/jSerialComm/2_11_2" --add-modules javafx.controls,javafx.graphics,javafx.fxml,javaf.desktop,javafx.swing,com.fazecast.jSerialComm --java-options "-Dprism.order=sw -Dprism.verbose=true -Djava.library.path=/Users/veerabhadram/Desktop/Aadarsh/Development/Java/java_libs/javafx-sdk-23.0.1/lib"
```
